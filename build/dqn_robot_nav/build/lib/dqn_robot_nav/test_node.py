...
class DQNTestNode(Node):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.get_logger().info("Model charged")
        except:
            self.get_logger().error("Cant be charged")
            return

        self.get_logger().info("Initialize model testing...")
    ...
    def run_tests(self, n_tests=10):
        ...
        self.get_logger().info(f"Colissions  : {collisions}")
